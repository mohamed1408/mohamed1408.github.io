...
const grouped_bar_chart = () => {
    ...
    svg
        ...
        .attr("fill", function (d) {
            return color(d.key); // shadeColor(color(d.key), 200);
        })
    ...
    lgndSVG.selectAll("lgndrects")
        .data(subgroups)
        .enter()
        .append("rect")
        .attr("x", 10)
        .attr("y", function (d, i) { return 100 + i * 55 }) // 100 is where the first dot appears. 25 is the distance between dots
        .attr("rx", 7)
        .attr("width", 50)
        .attr("height", 30)
    ...
    lgndSVG.selectAll("mylabels")
        .data(subgroups)
        .enter()
        .append("text")
        .attr("x", 70)
        .attr("y", function (d, i) { return 115 + i * 55 }) // 100 is where the first dot appears. 25 is the distance between dots
        .style("fill", function (d) { return color(d) })
